                ...
                <input type="hidden" class="form-control form-control-user" name="id" value="<?php echo $vehicleid; ?>">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" 
                            aria-describedby="emailHelp" value="<?php echo $vehiclename; ?>" placeholder="Enter Vehicle Name" name="txtvehicleName" id="txtempName">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" 
                            aria-describedby="emailHelp" value="<?php echo $vehiclemodel;?>" placeholder="Enter Model No." name="txtvehicleModel">
                    </div>
